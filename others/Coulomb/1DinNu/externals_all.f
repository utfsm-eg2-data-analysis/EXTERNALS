...
c ------- Write out sbsv(npts)[already there] and sigborn_cc [add] and f1cc [add] before ccor ---------   

c          write(17,'(1x,5f9.4,9e13.5)') e0sv(npts),epsv(npts),
c     >          thsv(npts),xsv(npts),q2set,sbsv(npts),sbisv(npts),
c     >          sbqesv(npts),srsv(npts),
c     >          srelsv(npts),srqesv(npts),srinsv(npts),  ccor
