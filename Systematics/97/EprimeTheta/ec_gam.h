...
//const float q_values[7]= {1.0, 1.17, 1.33, 1.55, 1.76, 2.7, 4.1 };
//const float v_values[7]= {2.2, 2.9, 3.2, 3.46, 3.73, 3.99, 4.25 };
...
//const float center_q[6] = { 1.135, 1.25, 1.44, 1.655, 2.23, 3.4 };
//const float center_v[6] = {2.55, 3.05, 3.33, 3.595, 3.86, 4.12 };
