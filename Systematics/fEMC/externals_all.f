...
! didnt work     EMCFAC = EMCFAC + 0.5*EMCFAC 
...
! didnt work      FITEMC_N  =  C *ATMP**ALPHA + C *ATMP**ALPHA*5
      SIG_N_P = 1.-0.8*X_U
      F_IS = .5*(1.+ SIG_N_P)/(Z/A +(1.-Z/A)*SIG_N_P)
      FITEMC_N = FITEMC_N/F_IS
! didnt work      FITEMC_N = (FITEMC_N*10)/F_IS
      RETURN                                                            
      END                                                               
...
!      W2     = W2*EMCFAC                                                
!      W1     = W1*EMCFAC                                                
       W2     = W2*(EMCFAC+0.3*EMCFAC)
       W1     = W1*(EMCFAC+0.3*EMCFAC)
