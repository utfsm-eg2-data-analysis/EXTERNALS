...
/*
 ...
 for(int nq=0;  nq<nqbins; nq++){
  for(int nv=0; nv<nvbins;nv++){
   out << nq << " " << nv << " " <<  RC_D[nq][nv] << " " << C_corr_D[nq][nv]<< endl;
  }
 }
 out.close();
 ...
 for(int nq=0;  nq<nqbins; nq++){
  for(int nv=0; nv<nvbins;nv++){
   out << nq << " " << nv << " " <<  RC_C[nq][nv] << " " << ratioRC_CD[nq][nv]<< " " << C_corr_C[nq][nv] << endl;
  }
 }
 out.close();
 ...
 for(int nq=0;  nq<nqbins; nq++){
  for(int nv=0; nv<nvbins;nv++){
   out << nq << " " << nv << " " <<  RC_Fe[nq][nv] << " " << ratioRC_FeD[nq][nv] <<" " << C_corr_Fe[nq][nv]<<endl;
  }
 }
 out.close();
 ...
 for(int nq=0;  nq<nqbins; nq++){
  for(int nv=0; nv<nvbins;nv++){
   out << nq << " " << nv << " " <<  RC_Pb[nq][nv] << " " << ratioRC_PbD[nq][nv]<< " " << C_corr_Pb[nq][nv]<<endl;
  }
 }
 out.close();
